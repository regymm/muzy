...
PL SD card -- due to no pullup resistors! A PMOD SD card module works.

~~PS load bitstream from SD card -- it seems impossible due to no big enough block of memory. Either SPI flash or DDR is required.~~ Now working with GenZ. 
